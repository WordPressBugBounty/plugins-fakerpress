 ...
 *
 * @method \FakerPress\ThirdParty\Cake\Chronos\ChronosInterface modify(string $relative)
 */
interface ChronosInterface extends DateTimeInterface
{
     ...
     *
     * @param \FakerPress\ThirdParty\Cake\Chronos\ChronosInterface $dt The instance to compare with.
     * @return bool
     * @see equals
     */
     ...
     *
     * @param \FakerPress\ThirdParty\Cake\Chronos\ChronosInterface $dt1 The instance to compare with.
     * @param \FakerPress\ThirdParty\Cake\Chronos\ChronosInterface $dt2 The instance to compare with.
     ...
     *
     * @param \FakerPress\ThirdParty\Cake\Chronos\ChronosInterface|null $dt The instance to compare with.
     * @return static
     */
     ...
     *
     * @param \FakerPress\ThirdParty\Cake\Chronos\ChronosInterface $dt The instance to check against.
     * @return bool
     */
     ...
     * 5 months after
     *
     * @param \FakerPress\ThirdParty\Cake\Chronos\ChronosInterface|null $other The datetime to compare with.
     ...
     *
     * @param \FakerPress\ThirdParty\Cake\Chronos\ChronosInterface|null $dt The instance to difference from.
     ...
     *
     * @param \FakerPress\ThirdParty\Cake\Chronos\ChronosInterval $ci An interval to traverse by
     * @param callable $callback The callback to use for filtering.
     * @param \FakerPress\ThirdParty\Cake\Chronos\ChronosInterface|null $dt The instance to difference from.
     * @param bool $abs Get the absolute of the difference
     * @return int
