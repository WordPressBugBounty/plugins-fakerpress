...
if (!\class_exists('Carbon\Carbon') && !\interface_exists('Carbon\CarbonInterface', false)) {
    ...
    class_alias('FakerPress\ThirdParty\Cake\Chronos\Chronos', 'Carbon\MutableDateTime');
    class_alias('FakerPress\ThirdParty\Cake\Chronos\ChronosInterface', 'Carbon\CarbonInterface');
}
